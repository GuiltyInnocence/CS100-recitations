 ...
 public:
  ...
  // Other members.
    ...
    \begin{itemize}
        ...
        \item \bluett{static} member function does not have \bluett{this} pointer.
    \end{itemize}
\end{frame}
...
p.set_x(4.2).set_y(3.5);
                \end{cpp}
                \item Will be mentioned again when we meet reloading \bluett{assignment operations}.
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{The Ctor Initializer List}
    ...
    \begin{itemize}
        ...
        \item \textbf{All the data members} will be initialized before the function body begins, \red{\textbf{in the order in which they appear in the class definition}}.
